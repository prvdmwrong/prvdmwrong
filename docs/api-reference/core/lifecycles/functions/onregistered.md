...
<h1 class="prvdmwrong-api-top">
  ...
  <span class="prvdmwrong-api-labels">
    <a class="prvdmwrong-api-source" href="https://github.com/prvdmwrong/prvdmwrong/blob/0.2/prvdmwrong/core/src/lifecycles.luau#L159" title="View source code on GitHub">
    view code
    </a>
  </span>
</h1>
